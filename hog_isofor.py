...
def gen_train_data(pass_intmp):
    ...
    for p in p_temp:
        ...
        #fd, hog_image = hog(img, orientations=orientations_number, pixels_per_cell=(cell_size, cell_size),cells_per_block=(block_size, block_size), visualize=True, channel_axis=4)
...
def train():
    ...
    clf = IsolationForest(n_estimators=100, max_samples='auto', contamination=nu, max_features=4, bootstrap=False, n_jobs=-1, random_state=1)
